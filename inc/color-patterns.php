 ...
 */
function brvry_custom_colors_css() {
	...
	/**
	 * Filter Bravery Base default saturation level.
	 *
	 * @since Bravery Base 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */

	$saturation          = absint( apply_filters( 'brvry_custom_colors_saturation', 100 ) );
	$saturation          = $saturation . '%';

	$lightness           = absint( apply_filters( 'brvry_custom_colors_lightness', 33 ) );
	$lightness           = $lightness . '%';

	$lightness_hover     = absint( apply_filters( 'brvry_custom_colors_lightness_hover', 23 ) );
	$lightness_hover     = $lightness_hover . '%';

	$lightness_selection = absint( apply_filters( 'brvry_custom_colors_lightness_selection', 90 ) );
	...
	/**
	 * Filters Bravery Base custom colors CSS.
	 *
	 * @since Bravery Base 1.0
	 *
	 ...
	 */
	return apply_filters( 'brvry_custom_colors_css', $css, $primary_color, $saturation );
}
